    ...
    return (
        ...
        <div className="card text-center" id="card-category">
            ...
            <button className='ClickImage'>
                <Link to={"/items?category="+props.category+"&subcategory=" + props.subcategory}   className='text3'> <img src={props.imgsrc} alt="..." className='card-img-top' id="card-img-top-category"/> </Link>
                </button>
